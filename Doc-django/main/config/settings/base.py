...
# Переопределяем подключения к БД
DATABASES["default"]["ATOMIC_REQUESTS"] = True
# DATABASES["default"]["ENGINE"] = 'django.db.backends.postgresql'
DATABASES["default"]["ENGINE"] = 'django.db.backends.postgresql_psycopg2'
DATABASES["default"]["NAME"] = 'nips'
DATABASES["default"]["USER"] = 'user1'
...
# Для разрешения CORS выбрать одно из этих двух, либо
# доступ всем либо только разрешенноым
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "main.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Sergio""", "sergio@example.com")]
...
# Количество шагов обработки изображения нейронной сетью
QUALITY = 3
